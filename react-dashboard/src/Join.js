        ...
        <div className="join-div">
            <div className="form-div">
                ...
                <Form onSubmit={onSubmit}>
                    ...
                    <Input className="join-name" type="string" autoFocus value={name} onChange={onChangeName}/>
                    {/* <p className="name-error">이름은 필수 입력 요소입니다.</p> */}
                    <Label className="join-label">
                    아이디
                    </Label>
                    <Input className="join-id" type="string" value={id} onChange={onChangeId}/>
                    <Label className="join-label">
                    비밀번호
                    </Label>
                    <Input className="join-pw" type="password" value={password} onChange={onChangePassword}/>
                    <Label className="join-label">
                    비밀번호 확인
                    </Label>
                    <Input className="join-pwcheck" type="password" value={passwordCheck} onChange={onChangePasswordCheck}/>
                    {/* <Label className="join-label">
                    좋아하는 메뉴
                    </Label>
